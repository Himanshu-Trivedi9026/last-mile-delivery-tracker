                  ...
                  <div className="absolute right-0 top-10 z-50 w-80 overflow-hidden rounded-xl border border-slate-200 bg-white shadow-xl">
                    ...
                    <div className="divide-y divide-slate-100">
                      ...
                      <div className="px-4 py-3 hover:bg-slate-50">
                        <div className="text-sm font-semibold text-slate-800">
                          Delivery operations updated
                        </div>

                        <div className="mt-1 text-xs text-slate-500">
                          Check your active deliveries and agent assignments.
                        </div>
                      </div>
                      ...
                      <div className="px-4 py-3 hover:bg-slate-50">
                        ...
                        <div className="mt-1 text-xs text-slate-500">
                          Available delivery agents can receive new orders.
                        </div>
                      </div>
                      ...
                      <div className="px-4 py-3 hover:bg-slate-50">
                        ...
                        <div className="mt-1 text-xs text-slate-500">
                          Review failed or rescheduled deliveries.
                        </div>
                      </div>
                    ...
                    <div className="border-t border-slate-100 px-4 py-3">
                      <button
                        ...
                        className="w-full rounded-lg bg-slate-50 px-3 py-2 text-xs font-semibold text-slate-700 hover:bg-slate-100"
                      >
                        Close
                      </button>
                    </div>
